...
- Repo :: https://github.com/dgutov/diff-hl
  ...
  #+end_src
** dotenv.el
- Repo :: https://github.com/amodelbello/dotenv.el
  #+begin_src emacs-lisp
    (use-package dotenv
      :ensure t
      :quelpa
      (dotenv :repo "amodelbello/dotenv.el"
...
** Flyspell
  #+begin_src emacs-lisp
    (setq-default ispell-program-name (dotenv-get "ISPELL_PATH" "/opt/homebrew/opt/ispell/bin/ispell"))
...
- Repo :: https://github.com/karthink/gptel
  #+begin_src emacs-lisp
    (use-package gptel
     :ensure t
     :config
     (setq gptel-api-key (dotenv-get "GPTEL_API_KEY")
  ...
  #+begin_src emacs-lisp
    (use-package grip-mode
      ...
      :config (setq grip-preview-use-webkit t
                    ...
                    grip-github-password (dotenv-get "GRIP_GITHUB_PASSWORD")))
  #+end_src
** ibuffer
...
- Docs: :: https://joostkremers.github.io/pandoc-mode/
  #+begin_src emacs-lisp
    (use-package pandoc-mode
      :ensure t
      :config (setq markdown-command (dotenv-get "PANDOC_PATH" "/opt/homebrew/bin/pandoc"))
