   ...
   #+begin_src emacs-lisp
     (use-package evil
       ...
       (setq evil-disable-insert-state-bindings t
             evil-toggle-key "")
       :config
       (setq evil-insert-state-cursor '(box "#824BB9")  ;; purple for emacs
             evil-normal-state-cursor '(box "#41903F")) ;; green for vim
       (evil-mode))
   #+end_src
...
**** lsp-server
     - Repo :: https://github.com/python-lsp/python-lsp-server
       ...
       #+begin_src emacs-lisp
         ...
         (setq lsp-pylsp-plugins-flake8-ignore '('D100 'D101 'D102 'E501))
       #+end_src
**** pyvenv
