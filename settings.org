...
- Docs :: https://orgmode.org/
  #+begin_src emacs-lisp
    ...
    (setq org-directory (dot-env-get "ORG_DIRECTORY_PATH" "~/.emacs.d/org-directory")
          ...
          org-work-file (concat org-directory "/work-notes.org")
          org-union-file (concat org-directory "/union-notes.org"))


    (setq org-capture-templates '(("s"
                                   "Standup Note"
                                   entry
                                   (file+headline org-work-file "Standup Items")
                                   "** %?\n %T\n %i\n" :empty-lines-after 1)
                                  ("m"
                                   "Meeting Note"
                                   entry
                                   (file+headline org-work-file "Meeting Items")
                                   "** %?\n %T\n %i\n" :empty-lines-after 1)
                                  ("i"
                                   "Issue Note"
                                   entry
                                   (file+headline org-work-file "Issue Items")
                                   "** %? %^g\n %T\n %l\n %i\n" :empty-lines-after 1)
                                  ("u"
                                   "Union Note"
                                   entry
...
* Custom Bindings
   #+begin_src emacs-lisp
     ...
     (define-key z-map (kbd "n") (find-file org-directory))
